...
7. Add User Sign up
  ...
  c. In users_controller.rb
    def new
      @user = User.new
    end
  d. Transform new.html.erb to
...
9. Setup error messages
  ...
  b. Create file views/shared/_error_messages.html.erb
    ...
    <% end %>
  c. Sign up with errors to see the error messages
